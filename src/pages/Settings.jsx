...
export default function Settings() {
  ...
  const tabs = [
    ...
    ...(isWorkspaceOwner ? [{ id: "workspace", label: "Workspace Settings" }] : []),
  ];
  ...
  useEffect(() => {
    if (activeTab === "workspace" && !isWorkspaceOwner) {
  ...
  return (
    <main className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-2">
