      ...
      <GradientBackground>
        <div className="flex min-h-screen">
          ...
          <div className="flex-1 flex flex-col ml-64">
            <TopBar title="GM-Only: Quest Details" />
            <main className="flex-1 p-8 overflow-auto">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
                <h1 className="text-3xl font-bold text-white mb-3">
                  GM Quest Notebook Only 💜
                </h1>
                <p className="text-zinc-300 mb-2">
                  Nice try, adventurer. This page is for scheming, foreshadowing, and
                  emotionally compromising your characters in peace.
                </p>
                <p className="text-zinc-400 text-sm">
                  Ask your DM nicely if you think you&apos;re allowed to see this.
                  Otherwise, consider this a{" "}
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="flex-1">
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-2 text-sm text-zinc-300">
                      {quest.tagline || "Add a one-line description for this quest."}
                    </p>
                  )}
                </div>
                ...
                <div className="flex flex-col items-start md:items-end gap-3 min-w-[200px]">
                    ...
                    {statusOptions.map((status) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            isEditing && handleFieldChange("status", status.value)
                          }
                  ...
                  {/* Type selector (in spirit – we just highlight selected) */}
                  <div className="flex flex-wrap gap-2 justify-end">
                    {typeOptions.map((type) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            isEditing && handleFieldChange("type", type.value)
                          }
                          className={`px-3 py-1 rounded-full text-xs font-medium border ${
                            isActive
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      onChange={(e) =>
                        handleFieldChange("playerSummary", e.target.value)
                      }
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      onChange={(e) =>
                        handleMultilineChange("playerSteps", e.target.value)
                      }
                      className="w-full bg-black/20 border border-white/10 rounded-xl px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:border-purple-400 resize-none"
                    ...
                    <p className="text-sm text-zinc-500">
                      No visible steps yet. You can outline what the party thinks the next
                      moves are.
                    </p>
                  )}
                </section>
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      onChange={(e) =>
                        handleFieldChange("visibleConsequences", e.target.value)
                      }
                      className="w-full bg-black/20 border border-white/10 rounded-xl px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:border-purple-400 resize-none"
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      onChange={(e) =>
                        handleFieldChange("playerRewards", e.target.value)
                      }
                      className="w-full bg-black/20 border border-white/10 rounded-xl px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:border-purple-400 resize-none"
              ...
              <div className="space-y-4">
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-sm text-zinc-400">
                      Use this to outline how the quest advances behind the scenes.
                    </p>
                  )}
                </section>
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      onChange={(e) =>
                        handleFieldChange("gmConsequences", e.target.value)
                      }
                      className="w-full bg-black/30 border border-rose-500/40 rounded-xl px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:border-rose-400 resize-none"
                    ...
                    <p className="text-sm text-zinc-200 whitespace-pre-line min-h-[3rem]">
                      {quest.gmConsequences ||
                        "Document the long-tail effects that only you know about (yet)."}
                    </p>
                  )}
                </section>
                ...
                <section className="bg-white/5 border border-white/10 rounded-2xl p-5">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-sm text-zinc-200 whitespace-pre-line min-h-[3rem]">
                      {quest.gmRewards ||
                        "Reward yourself too: note what this quest unlocks in terms of story power."}
                    </p>
                  )}
                </section>
              </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-xs text-zinc-500">
                      No tags yet. Add a few in Edit mode to group this quest with arcs,
                      locations, and lore.
                    </p>
                  )}
                </div>
