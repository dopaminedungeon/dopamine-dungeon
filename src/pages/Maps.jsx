...
import { mockMaps } from "../data/mockMaps.js";
          ...
          <div className="w-full max-w-xl bg-zinc-950 border border-white/10 rounded-2xl p-6">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-zinc-400 mb-1">Players (range)</label>
                  <input
                    type="text"
                    placeholder="e.g. 4-6"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="number"
                    value={formData.npcs}
                    onChange={(e) => setFormData({ ...formData, npcs: Number(e.target.value) })}
                    className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-white"
                  />
                </div>
