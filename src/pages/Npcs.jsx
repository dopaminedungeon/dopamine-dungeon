...
export default function Npcs() {
  ...
  const handleCreate = (e) => {
    ...
    // later we'll actually add it to state / backend
            ...
            {showCreateModal && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
                <div className="w-full max-w-lg bg-zinc-950 border border-white/10 rounded-2xl p-6">
                  <h2 className="text-xl font-bold text-white mb-4">Add New NPC</h2>
                  <form className="space-y-4" onSubmit={handleCreate}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm text-zinc-400 mb-1">Health</label>
                        <input
                          type="number"
                          min={1}
