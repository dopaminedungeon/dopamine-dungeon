            ...
            <main className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
              <div className="max-w-xl bg-white/5 border border-white/10 rounded-2xl p-6 text-center">
                ...
                <p className="text-zinc-400 text-sm">
                  The requested condition does not exist.
                </p>
                <Link to="/conditions" className="mt-4 inline-block text-purple-400 hover:underline">
  ...
  return (
    <GradientBackground>
      <div className="flex min-h-screen">
        <Sidebar />
        <div className="flex-1 flex flex-col ml-64">
          <TopBar title={`Condition Profile: ${condition.trackerName}`} />
