    ...
    return (
      <GradientBackground>
        <div className="flex min-h-screen">
          <Sidebar />
          <div className="flex flex-col flex-1 ml-64">
            <TopBar title="Relationship Not Found" />
            <main className="flex-1 p-10 flex flex-col items-start">
              <Link
                to="/relationships"
                className="text-purple-300 hover:text-purple-100 text-sm mb-4"
              >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-xs text-zinc-300 mt-2">
                    ...
                    <span
                      className={`rounded-full px-3 py-1 border ${statusColor}`}
                    >
                      {baseStatus}
                    </span>
                    {baseValence && (
                      <span className={`font-medium ${valenceColor}`}>
                        {baseValence}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex flex-col items-end gap-2 min-w-[180px] text-xs text-zinc-300">
                  ...
                  {isFaction && baseReputation != null && baseReputation !== "" && (
                    <div className="mt-2 w-full">
                      <p className="text-xs text-zinc-400 mb-1 text-right">
                        Reputation
                      </p>
                ...
                <section className="bg-black/40 border border-sky-500/25 rounded-xl p-5 backdrop-blur-md space-y-3">
                  ...
                  {editMode ? (
                    <div className="space-y-3 text-sm">
                      <div>
                        <h3 className="text-xs uppercase tracking-wide text-zinc-400 mb-1">
                          History Entries
                        </h3>
                        <textarea
                          name="history"
                  ...
                  <div className="grid grid-cols-1 gap-3 text-sm text-zinc-200">
                    ...
                    <div>
                      ...
                      {editMode ? (
                        ...
                        <span className={`inline-block text-xs ${valenceColor}`}>
                          {baseValence || "Not set"}
                        </span>
                      )}
                    </div>
                  ...
                  {editMode ? (
                    ...
                    return tags.length > 0 ? (
                      ...
                      <p className="text-sm text-zinc-400 italic">
                        No tags yet. Add some keywords to help future-you search
                        this later.
                      </p>
                    );
                  })()}
            ...
            <section className="bg-black/40 border border-white/15 rounded-xl p-5 backdrop-blur-md mb-10">
              ...
              <div className="flex flex-wrap gap-3 text-xs text-zinc-300">
                ...
                {isFaction && basePublic != null && basePublic !== "" && (
                  <span className="bg-white/10 px-2 py-1 rounded">
                    Public rep: {basePublic}/5
                  </span>
                )}
                {isFaction && baseReputation != null && baseReputation !== "" && (
                  <span className="bg-white/10 px-2 py-1 rounded">
                    GM rep: {baseReputation}/5
                  </span>
                )}
              </div>
            </section>
