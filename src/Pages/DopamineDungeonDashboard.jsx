                  ...
                  {mockNpcs.map((npc) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-white font-medium group-hover:text-purple-300 transition-colors">{npc.name}</p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                          item.rarity === 'Legendary' ? 'bg-gradient-to-br from-amber-500 to-orange-500' :
                          item.rarity === 'Epic' ? 'bg-gradient-to-br from-purple-500 to-violet-500' :
                          'bg-gradient-to-br from-zinc-500 to-zinc-600'
                        }`}>
                          {item.name.includes('Sword') ? <Swords className="w-5 h-5 text-white" /> :
                           item.name.includes('Shield') ? <Shield className="w-5 h-5 text-white" /> :
                           <Sparkles className="w-5 h-5 text-white" />}
                        </div>
                        <div>
                          <p className="text-white font-medium group-hover:text-blue-300 transition-colors">{item.name}</p>
                          <p className={`text-sm ${
                  ...
                  {mockSessions.map((session) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-white font-medium group-hover:text-emerald-300 transition-colors">{session.name}</p>
                          <p className="text-zinc-500 text-sm">{session.players} players</p>
                        </div>
                      </div>
